...
function generateEndOfNames(scene, rotation, meshZ=-100, meshY, meshX, color, opacity, title, fontSig){
...
loader.load( './fonts/helvetiker_regular.typeface.json', function ( font ) {
  var loader = new THREE.FontLoader();
  loader.load( './fonts/sigreg.json', function ( fontSig ) {
    ...
    sajnani = generateEndOfNames(sceneText, 5, -100, textFPos[4][0], textFPos[4][1]+15, 0xA9A9A9, 1, 'ajnani', fontSig);
    generateEndOfNames(sceneText, 5, -100, textSPos[4][0], textSPos[4][1]+15, 0xA9A9A9, 1, 'amar', fontSig);
    dynamicallyResize();
  });
